...
import com.erdojaro.ferenckovacsx.erdojaro_v1.mainviews.SplashActivity;
import com.erdojaro.ferenckovacsx.erdojaro_v1.javabeans.Fauna;
...
//    }
    ...
    protected AsyncTaskResponseContent doInBackground(Void... args) {
        ...
        if (Utils.isNetworkConnected()) {
            ...
            SharedPreferences sp = SplashActivity.splashContext.getSharedPreferences("appPreferences", Context.MODE_PRIVATE);
...
//        String funghiResponse = sendHTTPRequest(Constants.GET_POI);
                ...
                try {
                    ...
                    SharedPreferences sharedPref = SplashActivity.splashContext.getSharedPreferences("appPreferences", Context.MODE_PRIVATE);
