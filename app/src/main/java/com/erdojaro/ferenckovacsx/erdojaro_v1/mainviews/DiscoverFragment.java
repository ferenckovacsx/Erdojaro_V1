...
public class DiscoverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(com.erdojaro.ferenckovacsx.erdojaro_v1.R.layout.fragment_discover, container, false);

        //generate TabLayout
        discoverTabs = (TabLayout) fragmentView.findViewById(com.erdojaro.ferenckovacsx.erdojaro_v1.R.id.discoverTabLayout);
    ...
    private void replaceFragment(Fragment fragment, String TAG) {
        ...
        transaction.replace(com.erdojaro.ferenckovacsx.erdojaro_v1.R.id.child_fragment_container, fragment, TAG);
